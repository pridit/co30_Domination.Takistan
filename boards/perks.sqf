"Perks (20 score = 2 perks)" hintC [
    "There are currently 9 total perks that can be acquired, as role based perks are not yet complete.",
    ...
    "Any unlocked perks will reset on disconnect. On reconnect you will receive points to re-allocate dependant on your score when rejoining. Score is reset on server restart or when the round finishes."
]