...
#define THIS_FILE "fn_dirindicator.sqf"
#include "x_setup.sqf"

_this spawn {
    disableserialization;
    PARAMS_2(_center,_obj);
    ...
    IND_1 ctrlsettext "ca\missions_pmc\data\ui_dir_1_ca.paa";
    IND_2 ctrlsettext "ca\missions_pmc\data\ui_dir_2_ca.paa";
    IND_3 ctrlsettext "ca\missions_pmc\data\ui_dir_3_ca.paa";
    IND_4 ctrlsettext "ca\missions_pmc\data\ui_dir_4_ca.paa";

    //--- Display again after load
    _this spawn {scriptName "fn_diIndicator.sqf: Load restart";
        _load = 0 spawn {scriptName "fn_diIndicator.sqf: Load detection";
            disableserialization;
            waituntil {false};
        };
