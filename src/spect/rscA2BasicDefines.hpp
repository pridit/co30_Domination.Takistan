...
class SpectRscTextSmall: SpectRscText {
    h = 0.03;
    sizeEx = TextSize_small;
};
class SpectRscTitle: SpectRscText {
    style = ST_CENTER;
    x = 0.15;y = 0.06;
    w = 0.7;
};
class SpectRscPicture {
    access = ReadAndWrite;
    idc = -1;
