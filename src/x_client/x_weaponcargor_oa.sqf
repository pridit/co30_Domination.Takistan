// by Xeno
#define THIS_FILE "x_weaponcargor_oa.sqf"
#include "x_setup.sqf"
private "_vec";
PARAMS_1(_vec);
...
if (isNil "x_ranked_weapons") then {
        _x_ranked_weapons_w = [
            [
                // private rifles
                [
                    ["M16A2",5],["FN_FAL",5],["Sa58P_EP1",5],["Sa58V_EP1",5],["LeeEnfield",5]
                ],
                // corporal rifles (gets added to private rifles)
                [
                    ["M16A2GL",5],["M4A1",5],["G36C_camo",5],["G36A_camo",5],["G36K_camo",5],["M14_EP1",5]
                ],
                // sergeant rifles (gets added to corporal and private rifles)
                [
                    ["M4A3_CCO_EP1",5],["G36_C_SD_camo",5],["M79_EP1",5],["Sa58V_RCO_EP1",5],["Sa58V_CCO_EP1",5]
                ],
                // lieutenant rifles (gets added to...)
                [
                    ["FN_FAL_ANPVS4",5],["M4A3_RCO_GL_EP1",5],["SCAR_L_CQC",5],["SCAR_L_CQC_Holo",5],["M32_EP1",5]
                ],
                // captain rifles (gets added...)
                [
                    ["SCAR_L_STD_Mk4CQT",5],["SCAR_L_STD_EGLM_RCO",5],["SCAR_L_CQC_EGLM_Holo",5],["SCAR_L_STD_HOLO",5],["SCAR_H_CQC_CCO",5]
                ],
                // major rifles (gets...)
                [
            ...
            [
                ...
                // major sniper rifles
                [
                    ["SCAR_H_LNG_Sniper",5],["SCAR_H_LNG_Sniper_SD",5],["M107",5],["M110_NVG_EP1",5]
                ],
                // colonel sniper rifles
                [
                    ["SCAR_H_STD_TWS_SD",5],["m107_TWS_EP1",5],["M110_TWS_EP1",5]
                ]
            ],
            [
                // private MG
            ...
            [
                ...
                // sergeant pistols
                [
                    ["Colt1911",5],["revolver_gold_EP1",5]
                ],
                // lieutenant pistols
                [
                    ["glock17_EP1",5]
...
[_vec] spawn {
    scriptName "spawn_x_weaponcargor_oa1";
