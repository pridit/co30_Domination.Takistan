...
class GVAR(showPlayerNameRsc) {
    ...
    onLoad ="uiNamespace setVariable ['d_showPlayerNameRsc1', _this select 0]";
    onUnload = "uiNamespace setVariable ['d_showPlayerNameRsc1', nil]";
    class controls {
        class DisplayPlayerName: BBRscStructuredText {
            idc = 1000;
