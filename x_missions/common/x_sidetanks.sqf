...
#endif
if (GVAR(domdatabase)) then {
    _tank2 addMPEventHandler ["MPKilled", {if (isServer && {isPlayer (_this select 1)}) then {(_this select 1) call FUNC(PAddTankKillPoints)}}];
};
_tank2 lock true;
sleep 0.512;
...
#endif
if (GVAR(domdatabase)) then {
    _tank3 addMPEventHandler ["MPKilled", {if (isServer && {isPlayer (_this select 1)}) then {(_this select 1) call FUNC(PAddTankKillPoints)}}];
};
_tank3 lock true;
sleep 0.512;
...
#endif
if (GVAR(domdatabase)) then {
    _tank4 addMPEventHandler ["MPKilled", {if (isServer && {isPlayer (_this select 1)}) then {(_this select 1) call FUNC(PAddTankKillPoints)}}];
};
_tank4 lock true;
sleep 0.512;
...
#endif
if (GVAR(domdatabase)) then {
    _tank5 addMPEventHandler ["MPKilled", {if (isServer && {isPlayer (_this select 1)}) then {(_this select 1) call FUNC(PAddTankKillPoints)}}];
};
_tank5 lock true;
sleep 0.512;
...
#endif
if (GVAR(domdatabase)) then {
    _tank6 addMPEventHandler ["MPKilled", {if (isServer && {isPlayer (_this select 1)}) then {(_this select 1) call FUNC(PAddTankKillPoints)}}];
};
_tank6 lock true;
